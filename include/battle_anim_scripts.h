...
extern const u8 Move_GAMMA_BLAST[];
extern const u8 Move_STELLAR_CRASH[];
extern const u8 Move_SUPERNOVA[];
extern const u8 Move_PARTICLE_RAY[];
extern const u8 Move_NEUTRON_SLAM[];
extern const u8 Move_ASTRAL_BLOW[];
extern const u8 Move_METEOR_SHOWER[];
extern const u8 Move_LIGHT_SPEED[];
extern const u8 Move_GALAXY_PULSE[];
extern const u8 Move_PARADOX[];
extern const u8 Move_RADIATION[];
extern const u8 Move_COSMIC_FORCE[];
extern const u8 Move_STARRY_LIGHT[];
extern const u8 Move_COSMIC_PUNCH[];
extern const u8 Move_TWINKLE[];
extern const u8 Move_COMET_RUSH[];
extern const u8 Move_ARC_SLICER[];
extern const u8 Move_GAUSS_FLING[];
extern const u8 Move_BLACK_HOLE[];
extern const u8 Move_ORIGIN_POWER[];
