...
enum {
    ...
    NATIONAL_DEX_PICASSOUL,
    NATIONAL_DEX_DRAMPELEA,
    NATIONAL_DEX_KRAMPERD,
    NATIONAL_DEX_ECTEON,
    NATIONAL_DEX_CORRODAL,
    NATIONAL_DEX_MAGNELA,
    NATIONAL_DEX_MULTIPLEE,
    NATIONAL_DEX_DIVIDI,
    NATIONAL_DEX_LUMISTER,
    NATIONAL_DEX_VANTERN,
    NATIONAL_DEX_LUVSIC,
    NATIONAL_DEX_CELESTEON,
    NATIONAL_DEX_ALLNOWN,
    NATIONAL_DEX_FOSSILISK,
    NATIONAL_DEX_SOLUMBRA,
    NATIONAL_DEX_TELLUNA,
    NATIONAL_DEX_NUUMITAN,
    NATIONAL_DEX_MANDIGUILE,
    NATIONAL_DEX_MESMELYNX,
    NATIONAL_DEX_REGIFLARE,
    NATIONAL_DEX_SLYFETCHD,
    NATIONAL_DEX_FRIGITOAD,
    NATIONAL_DEX_FLUTTRET,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_FLUTTRET
